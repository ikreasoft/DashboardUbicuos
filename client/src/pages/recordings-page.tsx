...
import { Loader2, Play, AlertCircle, CheckCircle2, Download, Trash2, Tag, Search, Brain, Activity } from "lucide-react";
  ...
  const handleExportRecording = async (recording: Recording) => {
    try {
      ...
      toast({
        ...
        description: "La grabación se está descargando",
      });
    } catch (error) {
      toast({
        title: "Error",
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/50 text-white">
                      <div className="text-center">
                        ...
                        <Button
                          variant="secondary"
                          className="mt-2"
                          onClick={() => handleExportRecording(selectedRecording)}
                        >
